                ...
                <div className="flex items-center justify-center">
                    <div className="grid lg:grid-cols-3 gap-[14px]">
                        <div className="bg-white rounded-[28px] p-8 relative hover:bg-[#1649FF] hover:text-white how-to-get-started pb-16">
                            ...
                            <Link to={`/${i18n.language}/start-my-business`} className="btn-on text-[#1649FF] font-semibold text-lg absolute text-left bottom-5">{t('get_started_card1_button')}</Link>
                        </div>
                        <div className="bg-white rounded-[28px] p-8 relative  hover:bg-[#1649FF] hover:text-white how-to-get-started">
                            ...
                            <Link to={`/${i18n.language}/company-type`} className="btn-on text-[#1649FF] font-semibold absolute text-lg text-left bottom-5">{t('get_started_card2_button')}</Link>
                        </div>
                        <div className="bg-white rounded-[28px] p-8 relative hover:bg-[#1649FF] hover:text-white how-to-get-started">
                            ...
                            <Link to={`/${i18n.language}/company-type`} className="btn-on text-[#1649FF] font-semibold absolute text-lg text-left bottom-5">{t('get_started_card3_button')}</Link>
                        </div>
                    </div>
                </div>
            </div>

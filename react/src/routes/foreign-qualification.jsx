...
import { DocumentCheckIcon, InformationCircleIcon, MegaphoneIcon } from '@heroicons/react/24/outline'
...
export default function ForeignQualification() {
  ...
  return (
    <main>
        ...
        <Stats title={t('foreign_qualification_header3_title')}  icon1=<InformationCircleIcon className="w-12"/> icontitle1={t('foreign_qualification_header3_icon1_title')}  icondesc1={t('foreign_qualification_header3_icon1_text')}  icon2=<DocumentCheckIcon className="w-12"/> icontitle2={t('foreign_qualification_header3_icon2_title')}   icondesc2={t('foreign_qualification_header3_icon2_text')}  icon3=<MegaphoneIcon className="w-12"/> icontitle3={t('foreign_qualification_header3_icon3_title')}  icondesc3={t('foreign_qualification_header3_icon3_text')}  />

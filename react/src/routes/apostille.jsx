...
import apostille from '../images/apostille.jpg'
...
export default function Apostille() {
    ...
    return (
        <main>
            <Navbar />
            <LeftImgRightText img={apostille} heading={t('apostille_header1_uptitle_blue')} title={t('apostille_header1_maintitle_black')} desc={t('apostille_header1_text')} button={t('apostille_header1_button')} href={`/${i18n.language}/products/${productData[16].link}/contact`}/>

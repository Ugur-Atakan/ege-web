...
import renewal1 from '../images/renewal1.jpg'
import renewal2 from '../images/renewal2.jpg'
...
export default function RenevalRevival() {
    ...
    return (
        <main>
            <Navbar />
            <LeftImgRightText img={renewal1} heading={t('renewal_and_revival_header1_uptitle_blue')} title={t('renewal_and_revival_header1_maintitle_black')} desc={t('renewal_and_revival_header1_text')} button={t('renewal_and_revival_header1_button')} href={`/${i18n.language}/products/${productData[12].link}/contact`} />
...
<LeftImgRightText img={renewal2} heading title={t('renewal_and_revival_header4_title')} desc={t('renewal_and_revival_header4_text')}/>

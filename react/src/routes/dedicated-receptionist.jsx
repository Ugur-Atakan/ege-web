...
export default function DedicatedReceptionist() {
  ...
  return (
    <main>
      ...
      <ExclusiveSolution heading={t('dedicated_receptionist_header5_uptitle_blue')} title={t('dedicated_receptionist_header1_uptitle_black')} desc={t('dedicated_receptionist_header5_text_left')} rightdesc={t('dedicated_receptionist_header5_text_right')} button={t('dedicated_receptionist_header5_button')} href={`/${i18n.language}/products/${productData[6].link}/contact`} />
      <Footer />
    </main>
  )
}

...
export default function Compare({ lang }) {
    ...
    const packages = [
        ...
        { name: t('starter_packages_list4'), icon: <InformationCircleIcon />, registate: <Image src={bluecheckicon} alt='icon' />, doola: <Image src={blackcheckicon} alt='icon' />, zenbusiness: <div className="text-black">$199</div>, legalzoom: <div className="text-black">$249</div>, firstbase: <div className="text-black">$100</div> , description: t('starter_packages_list4_description')},
        ...
        { name: t('starter_packages_list7'), icon: <InformationCircleIcon />, registate: '$265', doola: <div className="text-black">$399</div>, zenbusiness: <div className="text-black">$449</div>, legalzoom: <div className="text-black">$510</div>, firstbase: <div className="text-black">$499</div>, description: t('starter_packages_list7_description'), },
    ]      

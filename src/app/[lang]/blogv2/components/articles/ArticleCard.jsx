...
const Article = ({ article, lang }) => {
    ...
    return (
        <div className='flex cursor-pointer flex-col' onClick={goToArticle}>
            <Image width={432} height={280} className="w-[432px] h-[280px] rounded-3xl" src={article.articleImage} alt='article-pic'/>
            ...
            <div className="w-[432px] text-black text-[28px] font-semibold leading-normal">{article.title}</div>
            <div className="w-[432px] py-2 text-zinc-500 text-lg font-semibold leading-normal">{article.excerpt}</div>

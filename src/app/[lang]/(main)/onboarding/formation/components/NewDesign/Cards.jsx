...
const Cards = ({ lang, cookie, pricing }) => {
  const router = useRouter();

  const setCookie = (tierName, features,  price, priceID) => {
    const ckie = { ...cookie, 'selectedPackage': { tierName, features, price, priceID }};
          ...
          >
            <div className="p-8 lg:pt-12 xl:p-10 xl:pt-14">
              ...
              <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between lg:flex-col lg:items-stretch">
                ...
                <button
                  onClick={() => setCookie(tier.name, tier.mainFeatures, tier.price, tier.priceID)}

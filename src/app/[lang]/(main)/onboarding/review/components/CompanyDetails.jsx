    ...
    return ( 
        <div className='bg-white border rounded-[32px] p-6 my-6'>
            ...
            <div className='flex items-center justify-between py-2'>
                ...
                <Link href={`/${lang}/onboarding/company-name`} className='font-semibold text-sm leading-6 text-[#1649FF]' >
                    {t("review_edit_button")}
                </Link>
            </div>
            <div className='flex items-center justify-between py-2'>
                ...
                <Link href={`/${lang}/onboarding/state`} className='font-semibold text-sm leading-6 text-[#1649FF]' >
                    {t("review_edit_button")}
                </Link>
            </div>
        </div>

        ...
        <div className='flex-col lg:flex-row flex items-start justify-between gap-8'>
          ...
          <div className='w-full'>
            ...
            <div className="relative mb-4">
              ...
              <button type="submit" onClick={() => router.push(`/${lang}/onboarding/`)} className="text-white absolute right-2.5 bottom-2.5 bg-[#1649FF] py-3 lg:py-4 px-7 rounded-2xl">{t('pricing_header2_footer_input_button')}</button>
            </div>

...
const Features = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4 md:px-8 lg:px-16 my-8 md:my-12 lg:my-16">
      <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4">
        <Image src={hammer} alt="hammer" className='mx-20' width={120} height={120} />
        <h2 className="w-full md:w-[350px] text-neutral-800 text-xl md:text-xl lg:text-3xl font-semibold font-['Inter'] leading-[1.5] md:leading-[44px]">
      ...
      <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4 mt-8 md:mt-0">
        <Image src={horse} className='mx-20' alt="horse" width={120} height={120} />
      ...
      <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4 mt-8 md:mt-0">
        <Image src={board} className='mx-20' alt="board" width={120} height={120} />
        <h2 className="w-full md:w-[350px] text-neutral-800 text-xl md:text-3xl lg:text-4xl font-semibold font-['Inter'] leading-[1.5] md:leading-[44px]">

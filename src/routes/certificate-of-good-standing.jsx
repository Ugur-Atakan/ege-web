...
export default function CertificateOfGoodStanding() {
  return (
    <main>
        <Navbar/>
        <LeftImgRightText heading='Manage Your Business' title='Certificate of Good Standing' img={topnotch} desc='Are you registering your company to another state and in need of a Certificate of Good standing? Or do you need it for something else?' button='Get Started Now' href='contact' reverse='true'/>

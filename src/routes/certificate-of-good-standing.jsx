...
export default function CertificateOfGoodStanding() {
  ...
  return (
    <main>
        <Navbar/>
        <LeftImgRightText heading={t('certificate_of_good_standing_header1_uptitle_blue')} title={t('certificate_of_good_standing_header1_uptitle_black')} img={topnotch} desc={t('certificate_of_good_standing_header1_text')} button={t('certificate_of_good_standing_header1_button')} href={`/${i18n.language}/products/${productData[8].link}/contact`}/>
        <Price price={t('price_package_certificate_of_good_standing')} />

...
export default function CertifiedCopyRequest() {
    return (
        <main>
            <Navbar />
            <LeftImgRightText heading='Manage Your Business' title='Certified Copy Request' img={topnotch} desc='Are you in need of a certified copy of a company document?' button='Get Started Now' href='contact' />
            <Price/>

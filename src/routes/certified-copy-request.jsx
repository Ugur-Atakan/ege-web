...
export default function CertifiedCopyRequest() {
    ...
    return (
        <main>
            <Navbar />
            <LeftImgRightText heading={t('certified_copy_request_header1_uptitle_blue')} title={t('certified_copy_request_header1_uptitle_black')} img={topnotch} desc={t('certified_copy_request_header1_text')} button={t('certified_copy_request_header1_button')}  href={`/${i18n.language}/products/${productData[17].link}/contact`} />
            <Price price={t('price_package_certified_copy_request')} />

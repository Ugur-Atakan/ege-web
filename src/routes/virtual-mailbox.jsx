...
function VirtualMailbox() {
  return (
    <main>
        <Navbar/>
        <LeftImgRightText heading='Admin Management' title='Virtual MailBox' desc='A virtual mailbox makes it easier to manage your mail & packages remotely. Choose our virtual mailbox service and secure the privacy of your mail.' button='Get Started Now' href={`/products/${productData[2].link}/contact`} img={vmb} />
        <Price/>
...
Your Virtual Mailbox account will be activated once we receive a signed and notarized USPS 1583 Form, and copies of your ID.' button='Get Started Now' img={vmb2} reverse='true' />

...
function VirtualMailbox() {
        ...
        return (
                <main>
                        <Navbar />
                        <LeftImgRightText heading={t('virtual_mailbox_header1_uptitle_blue')} title={t('virtual_mailbox_header1_uptitle_black')} desc={t('virtual_mailbox_header1_text')} button={t('virtual_mailbox_header1_button')} href={`/${i18n.language}/products/${productData[2].link}/contact`} img={vmb} />
                        <Price price={t('price_package_virtual_mailbox')} href={`/${i18n.language}/products/${productData[2].link}/contact`} />
                        ...
                        <ExclusiveSolution heading={t('virtual_mailbox_header5_uptitle_blue')} title={t('virtual_mailbox_header5_uptitle_black')} desc={t('virtual_mailbox_header5_text_left')} rightdesc={t('virtual_mailbox_header5_text_right')} button={t('virtual_mailbox_header5_button')} href={`/${i18n.language}/products/${productData[2].link}/contact`} />
                        <Footer />
                </main>
        )
}

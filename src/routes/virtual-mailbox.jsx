...
function VirtualMailbox() {
  return (
    <main>
        <Navbar/>
        <LeftImgRightText heading='Admin Management' title='Virtual MailBox' desc='A virtual mailbox makes it easier to manage your mail & packages remotely. Choose our virtual mailbox service and secure the privacy of your mail.' button='Get Started Now' href='contact' img={vmb} />
        <Price/>

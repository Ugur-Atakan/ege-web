...
export default function ForeignQualification() {
  ...
  return (
    <main>
        <Navbar/>
        <LeftImgRightText heading={t('foreign_qualification_header1_uptitle_blue')} title={t('foreign_qualification_header1_uptitle_black')}  img={topnotch} desc={t('foreign_qualification_header1_text')} button={t('foreign_qualification_header1_button')}   href={`/${i18n.language}/products/${productData[7].link}/contact`}/>
        <Price/>

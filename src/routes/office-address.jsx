...
export default function OfficeAddress() {
    return (
        <main>
            <Navbar />
            <LeftImgRightText heading='Admin Management' title='Physical Office Suite' desc='Have a professional business address for your company in Delaware!' button='Get Started Now' href='contact' img={oa1} />
            <Price/>

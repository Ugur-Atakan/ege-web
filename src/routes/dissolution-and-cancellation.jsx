...
import dissolution1 from '../images/dissolution1.jpg'
import dissolution2 from '../images/dissolution2.jpg'
...
export default function DissolutionAndCancellation() {
    ...
    return (
        <main>
            <Navbar />
            <LeftImgRightText img={dissolution1} heading={t('dissolution_header1_uptitle_blue')} title={t('dissolution_header1_maintitle_black')} desc={t('dissolution_header1_text')} button={t('dissolution_header1_button')}  href={`/${i18n.language}/products/${productData[13].link}/contact`} />
            <Price price={t('price_package_dissolution')} href={`/${i18n.language}/products/${productData[13].link}/contact`}/>
            ...
            <LeftImgRightText img={dissolution2} desc=<ul>{t('dissolution_header4_text1')}

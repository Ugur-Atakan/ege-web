...
export default function DissolutionAndCancellation() {
    ...
    return (
        <main>
            <Navbar />
            <LeftImgRightText img={topnotch} heading={t('dissolution_header1_uptitle_blue')} title={t('dissolution_header1_maintitle_black')} desc={t('dissolution_header1_text')} button={t('dissolution_header1_button')}  href={`/products/${productData[13].link}/contact`} />
            <Price/>

...
export default function VirtualPhoneNumber() {
    return (
        <main>
            <Navbar />
            <LeftImgRightText heading='Manage Your Business' title='Virtual Phone Number' desc='For all of your business phone call needs - instead of having multiple phone systems where messages can be forgotten and misplaced, our Phonecall Forwarding Service directs all of your calls to one place, to keep your communications aligned and centralized.' button='Get Started Now' href='contact' img={vpn} />
            <Price/>

...
function ComplianceReminder() {
  ...
  return (
    <main>
        <Navbar/>
        <LeftImgRightText heading={t('compliance_reminder_header1_uptitle_blue')} title={t('compliance_reminder_header1_uptitle_black')} desc={t('compliance_reminder_header1_text')} img={cr1} button={t('compliance_reminder_header1_button')} href={`/${i18n.language}/products/${productData[0].link}/contact`} />
        <Price price={t('price_package_compliance_reminder')}/>

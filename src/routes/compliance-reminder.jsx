...
function ComplianceReminder() {
  return (
    <main>
        <Navbar/>
        <LeftImgRightText heading='Admin Management' title='Compliance Reminder' desc='Do you have difficult time remembering your company’s compliance matters? No need to stress about that anymore! Stay compliant with our Compliance Reminder service.' img={cr1} button='Get Started Now' href='contact'/>
        <Price/>

...
export default function DoingBusinessAs() {
    return (
        <main>
            <Navbar />
            <LeftImgRightText img={topnotch} heading='Manage Your Business' title='Doing Business As (DBA)' desc='Do you want to amend your company’s formation documents or need a restated version of them?' button='Get Started Now' href='contact' reverse='true' />

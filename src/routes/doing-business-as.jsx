...
export default function DoingBusinessAs() {
    ...
    return (
        <main>
            <Navbar />
            <LeftImgRightText img={topnotch} heading={t('dba_header1_uptitle_blue')} title={t('dba_header1_maintitle_black')} desc={t('dba_header1_text')} button={t('dba_header1_button')} href={`/${i18n.language}/products/${productData[15].link}/contact`} />

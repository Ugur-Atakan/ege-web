...
export default function DedicatedReceptionist() {
  return (
    <main>
      <Navbar />
      <LeftImgRightText heading='Manage Your Business' title='Dedicated Receptionist Every Second Of Every Day' desc='Here at Registate, we take your calls without you having to lift a finger. We take care of every aspect of your business needs - including being your personal native-English speaking receptionist. Why? We work for you, to make your business work - and we never turn off, it really is that simple.' button='Get Started Now' href='contact' img={dr} />
      <Price/>

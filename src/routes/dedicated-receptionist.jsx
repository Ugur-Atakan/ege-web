...
export default function DedicatedReceptionist() {
  ...
  return (
    <main>
      <Navbar />
      <LeftImgRightText heading={t('dedicated_receptionist_header1_uptitle_blue')} title={t('dedicated_receptionist_header1_uptitle_black')} desc={t('dedicated_receptionist_header1_text')} button={t('dedicated_receptionist_header1_button')}  href={`/products/${productData[6].link}/contact`} img={dr} />
      <Price/>

...
export default function Ein() {
    return (
        <main>
            <Navbar />
            <LeftImgRightText heading='Manage Your Business' title='EIN' img={topnotch} desc='Do you need assistance with filing SS-4 Form and obtaining EIN? Registate is the right choice!' button='Get Started Now' href='contact' reverse='true' />

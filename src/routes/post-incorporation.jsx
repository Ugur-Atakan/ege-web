...
function Postincorporation() {
  ...
  return (
    <main>
      ...
      <ExclusiveSolution heading={t('post_incorp_header5_uptitle_blue')} title={t('post_incorp_header5_maintitle_black')} desc={t('post_incorp_header5_text_left')} rightdesc={t('post_incorp_header5_text_right')} button={t('post_incorp_header5_button')} href={`/${i18n.language}/products/${productData[19].link}/contact`} />
      <Footer />
    </main>
  )
}

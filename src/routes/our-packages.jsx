...
export default function OurPackages() {
    return (
        <main>
            <Navbar />
            <LeftImgRightText heading='Our Packages' title='Costs For Maintaining Your Business' desc="We are always available for a chat with our customers to help you make the best decision when it comes to our products. If you have a question or just want to keep in touch with us, we're always here to listen." button='Get Started Now' href='contact' img={topnotch} reverse='true' />
            <Price />

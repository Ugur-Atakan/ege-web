...
export default function RenevalRevival() {
    ...
    return (
        <main>
            <Navbar />
            <LeftImgRightText img={topnotch} heading={t('renewal_and_revival_header1_uptitle_blue')} title={t('renewal_and_revival_header1_maintitle_black')} desc={t('renewal_and_revival_header1_text')} button={t('renewal_and_revival_header1_button')} href={`/products/${productData[12].link}/contact`} />
           <Price price={t('price_package_renewal_revival')}/>
...
<LeftImgRightText img={whatweneed} heading title={t('renewal_and_revival_header4_title')} desc={t('renewal_and_revival_header4_text')}/>
            <ExclusiveSolution heading={t('renewal_and_revival_header5_uptitle_blue')} title={t('renewal_and_revival_header5_maintitle_black')} desc={t('renewal_and_revival_header5_text_left')} rightdesc={t('renewal_and_revival_header5_text_right')} button={t('renewal_and_revival_header5_button')}/>
            <Footer />
        </main>
    )
}

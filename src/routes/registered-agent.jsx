...
export default function RegisteredAgent() {
    return (
        <main>
            <Navbar />
            <LeftImgRightText heading='Admin Management' title='Registered Agent' desc="Are you in the process of forming your company but you don't have a registered agent yet? Appoint us as your registered agent! Or, you already have a registered agent but want to change it? Appoint your Delaware registered agent to Registate!" button='Get Started Now' img={whatweneed} reverse='true' />

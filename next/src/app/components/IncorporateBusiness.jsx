            ...
            <div className="mx-auto max-w-7xl lg:p-6 lg:px-12">
                ...
                <div className="block lg:flex items-start justify-between pt-12 pb-24 px-6 lg:px-12">
                    <div className="w-full lg:w-[60%]">
                        <h1 className='font-bold  text-[32px] lg:text-[64px] text-black leading-[38px] lg:leading-[64px] mb-6 lg:mb-24'>{'Video'} </h1>
                        <a
                            to={`/`}
                    ...
                    <div className="w-full lg:w-[40%] mt-4">
                        <div>
                            <p className="font-semibold text-lg leading-[24px]">{'Video Description'}</p>
                            <a
                                 to={`/`}

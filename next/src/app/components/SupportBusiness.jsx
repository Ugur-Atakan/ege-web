...
export default function SupportBusiness() {
  ...
  const stayCompliantPackage = [
    { name: 'after_formation_package1_title', description: 'after_formation_package1_description', button: 'after_formation_package1_button', href: `/`, img: hat },
    { name: 'after_formation_package2_title', description: 'after_formation_package2_description', button: 'after_formation_package2_button', href: `/`, img: folder },
    { name: 'after_formation_package3_title', description: 'after_formation_package3_description', button: 'after_formation_package3_button', href: `/`, img: calendar },
    { name: 'after_formation_package4_title', description: 'after_formation_package4_description', button: 'after_formation_package4_button', href: `/`, img: tic },
    { name: 'after_formation_package5_title', description: 'after_formation_package5_description', button: 'after_formation_package5_button', href: `/`, img: at },
    { name: 'after_formation_package6_title', description: 'after_formation_package6_description', button: 'after_formation_package6_button', href: `/`, img: navigator },
    { name: 'after_formation_package7_title', description: 'after_formation_package7_description', button: 'after_formation_package7_button', href: `/`, img: mail },
    { name: 'after_formation_package8_title', description: 'after_formation_package8_description', button: 'after_formation_package8_button', href: `/`, img: phone },
    { name: 'after_formation_package9_title', description: 'after_formation_package9_description', button: 'after_formation_package9_button', href: `/`, img: travel },
    { name: 'after_formation_package10_title', description: 'after_formation_package10_description', button: 'after_formation_package10_button', href: `/`, img: folder },
    { name: 'after_formation_package11_title', description: 'after_formation_package11_description', button: 'after_formation_package11_button', href: `/`, img: axe },
    { name: 'after_formation_package12_title', description: 'after_formation_package12_description', button: 'after_formation_package12_button', href: `/`, img: folder },
    { name: 'after_formation_package13_title', description: 'after_formation_package13_description', button: 'after_formation_package13_button', href: `/`, img: wallet },
    { name: 'after_formation_package14_title', description: 'after_formation_package14_description', button: 'after_formation_package14_button', href: `/`, img: filetext }
  ]
  const taxesPackage = [
    { name: 'after_formation_package15_title', description: 'after_formation_package15_description', button: 'after_formation_package15_button', href: `/`, img: sheild },
    { name: 'after_formation_package16_title', description: 'after_formation_package16_description', button: 'after_formation_package16_button', href: `/`, img: dollar },
    { name: 'after_formation_package17_title', description: 'after_formation_package17_description', button: 'after_formation_package17_button', href: `/`, img: locker }
  ]

  const growYourBusinessPackage = [
    { name: 'after_formation_package18_title', description: 'after_formation_package18_description', button: 'after_formation_package18_button', href: `/`, img: folder }
  ]
      ...
      <div className="mx-auto max-w-5xl border-t mt-4 lg:mt-16 border-white border-opacity-[0.20] py-12 px-6 lg:px-0">
        <div className="grid grid-cols-1 md:grid-cols:2 lg:grid-cols-3 items-start gap-6 lg:gap-3">
          <div className="flex items-start gap-3 justify-start lg:justify-center">
            ...
            <p className="text-white font-bold text-lg leading-6">{'after_formation_footer1'}</p>
          </div>
          <div className="flex items-start gap-3 justify-start lg:justify-center">
            <Image src={protectionicon} className='w-8 h-8 lg:w-6 lg:h-6' alt="protection icon" />
            <p className="text-white font-bold text-lg leading-6">{'after_formation_footer2'}</p>
          </div>
          <div className="flex items-start gap-3 justify-start lg:justify-center">
            <Image src={protectionicon} className='w-8 h-8 lg:w-6 lg:h-6' alt="protection icon" />
            <p className="text-white font-bold text-lg leading-6">{'after_formation_footer3'}</p>
          </div>
        </div>
      </div>
    </div >

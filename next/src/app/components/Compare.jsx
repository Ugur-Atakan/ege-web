...
export default function Compare() {
    ...
    const packages = [
        { name: 'Package 1', icon: <InformationCircleIcon />, registate: <Image src={bluecheckicon} alt='icon' />, doola: <div className="sr-only">-</div>, zenbusiness: <div className="sr-only">-</div>, legalzoom: <div className="sr-only">-</div>, firstbase: <div className="sr-only">-</div> },
        { name: 'Package 2', icon: <InformationCircleIcon />, registate: <Image src={bluecheckicon} alt='icon' />, doola: <div className="sr-only">-</div>, zenbusiness: <div className="sr-only">-</div>, legalzoom: <div className="sr-only">-</div>, firstbase: <div className="sr-only">-</div> },
        { name: 'Package 3', icon: <InformationCircleIcon />, registate: <Image src={bluecheckicon} alt='icon' />, doola: <Image src={blackcheckicon} alt='icon' />, zenbusiness: <div className="sr-only">-</div>, legalzoom: <div className="sr-only">-</div>, firstbase: <div className="sr-only">-</div> },
        { name: 'Package 4', icon: <InformationCircleIcon />, registate: <Image src={bluecheckicon} alt='icon' />, doola: <Image src={blackcheckicon} alt='icon' />, zenbusiness: <div className="text-black">$199</div>, legalzoom: <div className="text-black">$249</div>, firstbase: <div className="text-black">$100</div> },
        { name: 'Package 5', icon: <InformationCircleIcon />, registate: <Image src={bluecheckicon} alt='icon' />, doola: <div className="sr-only">-</div>, zenbusiness: <div className="sr-only">-</div>, legalzoom: <div className="sr-only">-</div>, firstbase: <div className="sr-only">-</div> },
        { name: 'Package 6', icon: <InformationCircleIcon />, registate: <Image src={bluecheckicon} alt='icon' />, doola: <div className="sr-only">-</div>, zenbusiness: <div className="sr-only">-</div>, legalzoom: <div className="sr-only">-</div>, firstbase: <Image src={blackcheckicon} alt='icon' /> },
        { name: 'Package 7', icon: <InformationCircleIcon />, registate: '$232', doola: <div className="text-black">$297</div>, zenbusiness: <div className="text-black">$449</div>, legalzoom: <div className="text-black">$510</div>, firstbase: <div className="text-black">$499</div>, description: 'Description', },
    ]       
        ...
        <div className="bg-[#ECEFF1]">
            <div className="mx-auto max-w-[966px] p-6 lg:px-12">
                <div className="text-left lg:text-center pt-12 lg:pt-8">
                    <h1 className="font-bold text-[32px] lg:text-[64px] text-[#222222] leading-[38px] lg:leading-[64px]">{'Loreum Ipsum'} <span className="text-[#1649FF] font-bold ">{'Loreum Ipsum'}</span></h1>
                </div>
            </div>
            <div className="mx-auto max-w-md px-6 py-0 lg:px-12">
                <div className="text-left lg:text-center">
                    <h1 className="font-bold text-lg text-[#222222]">{'Loreum Ipsum'} <span className="text-[#1649FF] mr-1 font-bold ">{'Loreum Ipsum'}</span>{'Loreum Ipsum'}</h1>
                </div>
            </div>

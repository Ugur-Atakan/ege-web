  ...
  return (
    <div className='bg-white'>
      <div className="mx-auto p-6 lg:px-8">
        <Link className='flex items-center gap-2' href={`/company-name`}>
          <ArrowLeftIcon className='text-[#1649FF] h-[18px] w-[18px]' />
          <span className='text-[#1649FF] text-lg font-semibold'>{'formation_back_button'}</span>
        </Link>
      </div>
      <div className='mx-auto max-w-5xl p-4'>
        <div className='text-left md:text-center'>
          <h1 className='font-semibold text-[26px] md:text-[40px] leading-[44px] text-[#222222]'>{'formation_title'}</h1>
        </div>
      ...
      <div className='mx-auto max-w-xs'>
        <div className='w-full flex flex-col items-center justify-center'>
          <p className='cursor-pointer md:py-6 font-semibold  text-[22px] leading-[26px] text-[#1649FF]'>{'formation_card_footer'}</p>
        </div>
      </div>
      <div className='mx-auto max-w-5xl p-4'>
                  ...
                  <thead>
                    <tr>
                      ...
                      >
                        ...
                        <span className='text-base leading-4 md:leading-normal pt-2 md:pt-0 md:text-lg block font-semibold'>{'formation_detail_description'}</span>
                      </th>

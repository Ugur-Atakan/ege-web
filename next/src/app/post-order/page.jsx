          ...
          successPayment && (
            <div className="md:min-h-screen block md:flex items-center justify-center bg-cover bg-center bg-image relative">
              ...
              <div className="md:absolute text-center top-1/2 left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 max-w-xl px-4 md:px-0">
                ...
                <Link href={`/`} className='rounded-[20px] bg-[#1649FF] md:bg-white text-white md:text-[#222222] font-semibold text-lg md:text-[22px] leading-[26px] py-3 md:py-6 px-6 md:px-12'>
                  Go to the main page
                </Link>
              </div>
              <div className="hidden md:block absolute right-48 top-48 transform -translate-y-1/2 animate-bounce">
                <Image src={smallstar} alt="" className="h-36" />
              </div>
              <div className="hidden: md:block absolute left-[28rem] top-48 transform -translate-y-1/2 animate-bounce">
                <Image src={darkstar} alt="" className="h-12" />
              </div>
          ...
          !successPayment && (
            <div className="md:min-h-screen block md:flex items-center justify-center bg-cover bg-center bg-image relative">
              ...
              <div className="md:absolute text-center top-1/2 left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 max-w-xl px-4 md:px-0">
                ...
                <Link href='#' onClick={handleExitFailed} className='rounded-[20px] bg-[#1649FF] md:bg-white text-white md:text-[#222222] font-semibold text-lg md:text-[22px] leading-[26px] py-3 md:py-6 px-6 md:px-12'>
                  Go to the payment page
                </Link>
              </div>
              <div className="hidden md:block absolute right-48 top-48 transform -translate-y-1/2 animate-bounce">
                <Image src={smallstar} alt='small-star' className="h-36" />
              </div>
              <div className="hidden: md:block absolute left-[28rem] top-48 transform -translate-y-1/2 animate-bounce">
                <Image src={darkstar} alt='dark-star' className="h-12" />
              </div>
              <div className="hidden md:block absolute left-[28rem] bottom-[38%] transform -translate-y-1/2 animate-bounce">
                <Image src={darkstar} alt='dark-star' className="h-12" />
              </div>
